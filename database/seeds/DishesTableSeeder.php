...
class DishesTableSeeder extends Seeder
{
     ...
     * @return void
     */
    public $names = ['Bánh canh', 'Bánh đa cua', 'Bún bò Huế', 'Bún bung', 'Bún chả', 'Bún chả cá', 'Bún chạo tôm', 'Bún đậu mắm tôm', 'Miến lươn', 'Bún thịt nướng', 'Bún thang', 'Cơm gà Quảng Nam', 'Cơm cháy Ninh Bình, Cơm cháy hải sản', 'Rau muống xào tỏi', 'Xôi gà', 'Xôi đỗ xanh', 'Xôi lá cẩm', 'Cá lóc nướng trui',  'Chả cá thát lát', 'Chả cá Lã Vọng', '
    Trà xanh hương lài
    ...
    public $descriptions = ['Được làm từ bột gạo, bột mì, hoặc bột sắn hoặc bột gạo pha bột sắn cán thành tấm và cắt ra thành sợi to và ngắn với nước dùng được nấu từ tôm, cá, giò heo... thêm gia vị tùy theo từng loại', 'Được làm từ bột gạo, bột mì, hoặc bột sắn hoặc bột gạo pha bột sắn cán thành tấm và cắt ra thành sợi to và ngắn với nước dùng được nấu từ tôm, cá, giò heo... thêm gia vị tùy theo từng loại', 'Được làm từ bột gạo, bột mì, hoặc bột sắn hoặc bột gạo pha bột sắn cán thành tấm và cắt ra thành sợi to và ngắn với nước dùng được nấu từ tôm, cá, giò heo... thêm gia vị tùy theo từng loại', 'Bún nấu với sườn và dọc mùng', 'Được làm từ sợi mì bằng bột gạo xay mịn và tráng thành từng lớp bánh mỏng, sau đó thái theo chiều ngang để có những sợi mì mỏng khoảng 2mm. Sợi mì làm bằng bột mỳ được trộn thêm một số phụ gia cho đạt độ dòn, dai.', 
