...
<header class="mdl-layout__header">
	...
	for="more"><li class="mdl-menu__item">Settings</li>
...
<header class="mdl-layout__header">
	...
	<button class="mdl-button mdl-js-button mdl-button--raised" style = "width: 20 px" onclick="window.location='{{ route("auth/login") }}'"> LOG IN </button>
	<button id="more"
...
<div class="mdl-grid"> 
	...
	<div class="mdl-cell mdl-cell--3-col">
		<a class="mdl-card mdl-shadow--2dp">
			<div class="mdl-card__title" style="background: '{{Asset('images/cotoneaster.jpg')}}'">
				<h2 class="mdl-card__title-text">{{ $dish->link }}</h2>
			</div>
